...
public class AudioPlayer extends ViewPart implements BasicPlayerListener {
	public static final String ID = "com.delegreg.rpgm.views.audio"; //$NON-NLS-1$
	...
	public void createPartControl(Composite parent) {
		...
		title.setText(Messages.AudioPlayer_CurrentRessource);
	...
	private void makeActions() {
		...
		actionPrevious.setText(Messages.AudioPlayer_Previous);
		actionPrevious.setToolTipText(Messages.AudioPlayer_PreviousTooltip);
		actionPrevious.setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(Application.PLUGIN_ID, IImageKeys.PREVSONG));
		...
		actionPlay.setText(Messages.AudioPlayer_Play);
		actionPlay.setToolTipText(Messages.AudioPlayer_PlayTooltip);
		actionPlay.setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(Application.PLUGIN_ID, IImageKeys.PLAYSONG));
		...
		actionPauseResume.setText(Messages.AudioPlayer_Pause);
		actionPauseResume.setToolTipText(Messages.AudioPlayer_PauseTooltip);
		actionPauseResume.setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(Application.PLUGIN_ID, IImageKeys.PAUSERESUME));
		...
		actionStop.setText(Messages.AudioPlayer_Stop);
		actionStop.setToolTipText(Messages.AudioPlayer_StopTooltip);
		actionStop.setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(Application.PLUGIN_ID, IImageKeys.STOPSONG));
		...
		actionNext.setText(Messages.AudioPlayer_Next);
		actionNext.setToolTipText(Messages.AudioPlayer_NextTooltip);
		actionNext.setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(Application.PLUGIN_ID, IImageKeys.NEXTSONG));
		...
		actionClear.setText(Messages.AudioPlayer_Clear);
		actionClear.setToolTipText(Messages.AudioPlayer_ClearTooltip);
		actionClear.setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(Application.PLUGIN_ID, IImageKeys.DELETEITEM));

		//random
		actionRandom = new Action(Messages.AudioPlayer_Random,Action.AS_CHECK_BOX){
			public void run(){
		...
		actionRandom.setToolTipText(Messages.AudioPlayer_RandomTooltip);
		actionRandom.setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(Application.PLUGIN_ID, IImageKeys.RANDOM));

		//loop single
		actionLoopSingle = new Action(Messages.AudioPlayer_Loop,Action.AS_CHECK_BOX){
			public void run(){
		...
		actionLoopSingle.setToolTipText(Messages.AudioPlayer_LoopTooltip);
		actionLoopSingle.setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(Application.PLUGIN_ID, IImageKeys.LOOP));

		//loop single
		actionLoopAll = new Action(Messages.AudioPlayer_Looplist,Action.AS_CHECK_BOX){
			public void run(){
		...
		actionLoopAll.setToolTipText(Messages.AudioPlayer_LooplistTooltip);
		actionLoopAll.setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(Application.PLUGIN_ID, IImageKeys.LOOPALL));
	...
	public void setDocument(AudioDocument doc) {
        if (doc != null){
        	document=doc;
        	setPartName(Messages.AudioPlayer_Title + doc.getName());        	
