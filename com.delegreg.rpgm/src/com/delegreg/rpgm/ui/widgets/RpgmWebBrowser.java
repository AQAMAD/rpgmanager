...
public class RpgmWebBrowser extends Composite {
	...
	public RpgmWebBrowser(Composite parent, int style) {
		super(parent,style);
		...
		private void makeActions() {
			actionBackward = new Action(Messages.HttpDocView_Backward, AbstractUIPlugin
			...
			actionForward = new Action(Messages.HttpDocView_Forward, AbstractUIPlugin
					.imageDescriptorFromPlugin(Application.PLUGIN_ID,
							IImageKeys.FORWARD)) {
				public void run() {
					browser.forward();
			...
			actionStop = new Action(Messages.HttpDocView_Stop, AbstractUIPlugin
					.imageDescriptorFromPlugin(Application.PLUGIN_ID,
							IImageKeys.STOP)) {
				public void run() {
					browser.stop();
			...
			actionRefresh = new Action(Messages.HttpDocView_Refresh, AbstractUIPlugin
					.imageDescriptorFromPlugin(Application.PLUGIN_ID,
							IImageKeys.REFRESH)) {
				public void run() {
					browser.refresh();
			...
			actionHome = new Action(Messages.HttpDocView_Home, AbstractUIPlugin
					.imageDescriptorFromPlugin(Application.PLUGIN_ID,
							IImageKeys.HOME)) {
				public void run() {
