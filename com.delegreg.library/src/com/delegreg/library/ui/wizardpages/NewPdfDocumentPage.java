...
public class NewPdfDocumentPage extends WizardPage implements INewContaineableDetailPage {
	...
	private Button chkIndexContent;
	
	/**
	 * Create the wizard.
	 */
	public NewPdfDocumentPage(String pageName) {
		super(pageName);
	}
	 ...
	 */
	public NewPdfDocumentPage(String pageName, String title,
	...
	public void createControl(Composite parent) {
		...
		new Label(container, SWT.NONE);
		{
			chkIndexContent = new Button(container, SWT.CHECK);
			chkIndexContent.setText("Index Content");
		}
		new Label(container, SWT.NONE);
		onEnterPage();
	}
