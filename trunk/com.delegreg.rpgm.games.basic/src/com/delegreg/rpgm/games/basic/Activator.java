...
import com.delegreg.rpgm.games.basic.statblocks.ui.D20StatBlockDetailsPage;
...
public class Activator extends AbstractUIPlugin implements IStartup {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.delegreg.rpgm.games.basic"; //$NON-NLS-1$
	...
	public void earlyStartup() {
		//System.out.println("start basic"); //$NON-NLS-1$
