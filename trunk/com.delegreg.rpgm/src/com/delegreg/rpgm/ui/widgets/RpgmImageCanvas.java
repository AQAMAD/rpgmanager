...
import com.delegreg.rpgm.util.SWT2Dutil;
 ...
 */
public class RpgmImageCanvas extends Canvas {
	...
	public RpgmImageCanvas(final Composite parent) {
	 ...
	 */
	public RpgmImageCanvas(final Composite parent, int style) {
	...
	private final class ZoomOutAction extends Action {
		public ZoomOutAction() {
			setText(Messages.PDFDocView_ZoomOut);
			setToolTipText(Messages.PDFDocView_ZoomOut);
			setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(Application.PLUGIN_ID, IImageKeys.ZOOMOUT));
		}
		@Override
		public void run() {	
			zoomOut();
	...
	private final class ZoomInAction extends Action {
		public ZoomInAction() {
			setText(Messages.PDFDocView_ZoomIn);
			setToolTipText(Messages.PDFDocView_ZoomIn);
			setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(Application.PLUGIN_ID, IImageKeys.ZOOMIN));
		}
		@Override
		public void run() {	
			zoomIn();
