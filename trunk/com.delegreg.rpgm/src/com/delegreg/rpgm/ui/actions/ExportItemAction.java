...
public class ExportItemAction extends Action implements ISelectionListener,
	...
	public void processSelection(){
		if (selectedItem instanceof Campaigns) {
			setEnabled(false);
		} else if (selectedItem instanceof Sequences) {
			setEnabled(false);
		} else if (selectedItem instanceof Locations) {
			setEnabled(false);
		} else if (selectedItem instanceof Groups) {
			setEnabled(false);
		} else if (selectedItem instanceof Libraries) {
			setEnabled(false);
		} else {
			setEnabled(true);
		}		
	...
	public void run() {
		...
		try {
			...
			String str=Serializer.getInstance().toXML(selectedItem);
