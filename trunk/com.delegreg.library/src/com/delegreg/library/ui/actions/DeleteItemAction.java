...
public class DeleteItemAction extends Action implements ISelectionListener,
	...
	public final static String ID = "com.delegreg.library.deleteItem"; //$NON-NLS-1$
	...
	public DeleteItemAction(IWorkbenchWindow window) {
	  ...
	  setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(Activator.PLUGIN_ID, IImageKeys.DELETEITEM));
